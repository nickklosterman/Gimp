(define (script-fu-Anaglyph5 theImage drawable displacement_offset_x displacement_offset_y  displacement_type edge_behavior levelsmode)
...
(script-fu-register "script-fu-levels"
                    _"<Image>/Script-Fu/AnaglyphTools/Anaglyph5"
                    "modifiy levels."
                    "InkyDinky"
                    "InkyDinky"
                    "2011 11 9"
