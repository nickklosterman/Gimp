(define (script-fu-flickerglyph_no_displ_map_4layer theImage drawable displacement_offset_x displacement_offset_y  displacement_type edge_behavior levelsmode)

  (let* (
	 (displmapLyr (car (gimp-layer-copy drawable TRUE)))
	 (origimageLyr (car (gimp-layer-copy drawable TRUE)))
	 (origimage2Lyr (car (gimp-layer-copy drawable TRUE)))
...
(script-fu-register "script-fu-flickerglyph_no_displ_map_4layer"
                    _"<Image>/Script-Fu/AnaglyphTools/FlickerGlyph-From-Image-4layer"
